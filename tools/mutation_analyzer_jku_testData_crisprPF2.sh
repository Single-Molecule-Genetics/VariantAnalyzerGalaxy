...
path="/run/user/1000/gvfs/smb-share:server=140.78.123.183,share=analysis%20uw%20monika/WashingtonData_November2019/CRISPR_DS/Results_PF2/PF2_Hg38"
patho="/run/user/1000/gvfs/smb-share:server=140.78.123.183,share=analysis%20uw%20monika/WashingtonData_November2019/CRISPR_DS/Results_PF2/PF2_Hg38_FASTQ10_noSCT_FS1_freeBayes"
#
...
basename="PF2_FS1_RL36_Barcode1"
...
outfile1=$patho/"FreeBayes_"$basename".vcf"
file2=$path/"DCS_"$basename".bam"
file3=$path/"Aligned_Families_"$basename".tabular"

outfile=$patho/"Interesting_Reads_"$basename"_pysam_thresh0.fastq"
pickle_file=$patho/"tag_count_dict_"$basename"_pysam_thresh0.pkl"

file=$patho"/Interesting_Reads_"$basename"_pysam_thresh0"

file2s=$path/"SSCS_"$basename".bam"
sscs_counts_pickle=$patho/"SSCS_counts_"$basename"_pysam_thresh100.pkl"

outfile2=$patho/"mutant_reads_summary_short_trim_"$basename"_March2020.xlsx"
